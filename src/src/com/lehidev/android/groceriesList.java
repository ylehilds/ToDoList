...
public class groceriesList extends Activity{
	public static final String PREFS_NAME = "MyPrefsFileGroceries";
	  ...
	  protected void onCreate(Bundle savedInstanceState) {
	    ...
	    emailButton.setOnClickListener(new View.OnClickListener() {
		      ...
		      public void onClick(View view) {
		    	  if (todoItems.size() !=0)
		    	  {
		    	  String email="Groceries To Get List: \n\n";
		        ...
		        intent.putExtra(Intent.EXTRA_SUBJECT, "Groceries To Get List");
		        ...
		        {
		        	Toast.makeText(groceriesList.this, "There are not email clients installed.", Toast.LENGTH_SHORT).show();
		        }
		      }
		    	  else  Toast.makeText(groceriesList.this, "List is Empty!", Toast.LENGTH_SHORT).show();
		      }
		    });
	    ...
	    backButton.setOnClickListener(new View.OnClickListener() {
		      ...
		      @Override
		      public void onClick(View view) {
		        Intent intent = new Intent(groceriesList.this, ToDoList.class);
...
myListView.setAdapter(aa);
        ...
        clearListButton.setOnClickListener(new View.OnClickListener() {
        	 @Override
		      public void onClick(View view) {
        		 AlertDialog.Builder adb=new AlertDialog.Builder(groceriesList.this);
