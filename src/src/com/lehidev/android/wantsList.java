...
public class wantsList extends Activity{
	public static final String PREFS_NAME = "MyPrefsFileWants";
	  ...
	  protected void onCreate(Bundle savedInstanceState) {
	    ...
	    emailButton.setOnClickListener(new View.OnClickListener() {
		      ...
		      public void onClick(View view) {
		        ...
		        intent.putExtra(Intent.EXTRA_SUBJECT, "Wants List");
		        ...
		        {
		        	Toast.makeText(wantsList.this, "There are not email clients installed.", Toast.LENGTH_SHORT).show();
		        }
		      }
		    	  else  Toast.makeText(wantsList.this, "List is Empty!", Toast.LENGTH_SHORT).show();
		      }
		    });
	    ...
	    backButton.setOnClickListener(new View.OnClickListener() {
		      ...
		      @Override
		      public void onClick(View view) {
		        Intent intent = new Intent(wantsList.this, ToDoList.class);
...
clearListButton.setOnClickListener(new View.OnClickListener() {
        	 ...
        	 @Override
		      public void onClick(View view) {
        		 AlertDialog.Builder adb=new AlertDialog.Builder(wantsList.this);
