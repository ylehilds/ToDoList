...
public class workList extends Activity{
	public static final String PREFS_NAME = "MyPrefsFileWork";
	  ...
	  protected void onCreate(Bundle savedInstanceState) {
	    ...
	    emailButton.setOnClickListener(new View.OnClickListener() {
		      ...
		      public void onClick(View view) {
		        ...
		        intent.putExtra(Intent.EXTRA_SUBJECT, "Work To Do List");
		        ...
		        {
		        	Toast.makeText(workList.this, "There are not email clients installed.", Toast.LENGTH_SHORT).show();
		        }
		      }
		    	  else  Toast.makeText(workList.this, "List is Empty!", Toast.LENGTH_SHORT).show();
		      }
		    });
	    ...
	    backButton.setOnClickListener(new View.OnClickListener() {
		      ...
		      @Override
		      public void onClick(View view) {
		        Intent intent = new Intent(workList.this, ToDoList.class);
...
myListView.setAdapter(aa);
        ...
        clearListButton.setOnClickListener(new View.OnClickListener() {
        	 @Override
		      public void onClick(View view) {
        		 AlertDialog.Builder adb=new AlertDialog.Builder(workList.this);
